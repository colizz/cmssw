...
fatJetTable = simplePATJetFlatTableProducer.clone(
    ...
    variables = cms.PSet(P4Vars,
        ...
        globalParT3_Xqq = Var("bDiscriminator('pfGlobalParticleTransformerAK8JetTags:probXqq')",float,doc="Mass-decorrelated GlobalParT-3 X->qq score",precision=10),
        ...
        globalParT3_massCorrX2p = Var("bDiscriminator('pfGlobalParticleTransformerAK8JetTags:massCorrX2p')",float,doc="GlobalParT-3 mass regression corrector for X->2-prong jet with respect to the original jet mass. Use (massCorrX2p * mass * (1 - rawFactor)) to get the regressed mass",precision=10),
        globalParT3_massCorrXWW = Var("bDiscriminator('pfGlobalParticleTransformerAK8JetTags:massCorrXWW')",float,doc="GlobalParT-3 mass regression corrector for X->WW (4-prong) jet with respect to the original jet mass. Use (massCorrXWW * mass * (1 - rawFactor)) to get the regressed mass",precision=10),
        globalParT3_massCorrTopbW = Var("bDiscriminator('pfGlobalParticleTransformerAK8JetTags:massCorrTopbW')",float,doc="GlobalParT-3 mass regression corrector for top-like jet with respect to the original jet mass. Use (massCorrTopbW * mass * (1 - rawFactor)) to get the regressed mass",precision=10),
        globalParT3_massCorrQCD = Var("bDiscriminator('pfGlobalParticleTransformerAK8JetTags:massCorrQCD')",float,doc="GlobalParT-3 mass regression corrector for QCD jet with respect to the original jet mass. Use (massCorrQCD * mass * (1 - rawFactor)) to get the regressed mass",precision=10),
